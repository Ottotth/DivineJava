...
public class DivineService {
  ...
  public OpenRouterResponseDTO torotThreeCards(String lan, String about) {
  ...
  public OpenRouterResponseDTO plum(String lan, String about) {
  ...
  public OpenRouterResponseDTO lenormand(String lan, String about) {
  ...
  public OpenRouterResponseDTO coin(String lan, String about){
